...
export default function ApplicationManagement() {
  ...
  return (
    <div className="p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-white mb-2">Applications</h1>
        <p className="text-white/50">Manage Candidate Applications</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        {summaryCards.map((card, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-[#141414] border border-white/[0.08] rounded-xl p-6 hover:border-[#FF5A1F]/30 transition-all hover:shadow-[0_0_20px_rgba(255,90,31,0.1)]"
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 bg-gradient-to-br ${card.color} opacity-20 rounded-lg flex items-center justify-center`}>
      ...
      <div className="bg-[#141414] border border-white/[0.08] rounded-xl p-6 mb-6">
        <div className="grid grid-cols-5 gap-4">
          ...
          {/* Department Filter */}
          <select className="bg-white/[0.05] border border-white/[0.08] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-[#FF5A1F]/50">
