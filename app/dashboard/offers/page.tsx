    ...
    <div className="min-h-screen bg-[#0A0A0A] p-8 flex flex-col">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-4xl font-bold text-white">Offers</h1>
            <p className="text-white/50">Manage and track job offers</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-2xl">
          <div className="bg-gradient-to-br from-[#141414] to-[#0F0F0F] border border-white/[0.08] rounded-2xl p-12 text-center hover:border-[#FF5A1F]/20 hover:shadow-[0_0_30px_rgba(255,90,31,0.1)] transition-all duration-300">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="relative bg-[#FF5A1F]/20 p-6 rounded-2xl">
                  <Gift className="w-12 h-12 text-[#FF5A1F]" />
                </div>
              </div>
            </div>
            ...
            <p className="text-lg text-white/70 mb-4">
              Create, manage, and track offers with comprehensive offer management tools.
            </p>
            <p className="text-white/50 mb-8">
              Monitor offer acceptance rates and manage the final stage of your hiring process efficiently.
            </p>
            ...
            <div className="space-y-3 mb-8 text-left">
              <div className="flex items-center gap-3 text-white/70">
                ...
                <span>Generate and send customized offers</span>
              </div>
              <div className="flex items-center gap-3 text-white/70">
                <Zap className="w-4 h-4 text-[#FF5A1F]" />
                <span>Track offer status and responses</span>
              </div>
              <div className="flex items-center gap-3 text-white/70">
                <Zap className="w-4 h-4 text-[#FF5A1F]" />
                <span>Manage negotiations and counter-offers</span>
              </div>
            </div>
