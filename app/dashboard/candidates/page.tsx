      ...
      <div className="mb-12">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-white/50">Powerful candidate management system</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-2xl">
          <div className="bg-gradient-to-br from-[#141414] to-[#0F0F0F] border border-white/[0.08] rounded-2xl p-12 text-center hover:border-[#FF5A1F]/20 hover:shadow-[0_0_30px_rgba(255,90,31,0.1)] transition-all duration-300">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="relative bg-[#FF5A1F]/20 p-6 rounded-2xl">
                  <Users className="w-12 h-12 text-[#FF5A1F]" />
                </div>
              </div>
            </div>
            ...
            <p className="text-lg text-white/70 mb-4">
              We&apos;re building a powerful candidate management system with advanced search, filtering, and profile management.
            </p>
            <p className="text-white/50 mb-8">
              This feature will help you discover and manage the best talents for your organization.
            </p>
            ...
            <div className="space-y-3 mb-8 text-left">
              <div className="flex items-center gap-3 text-white/70">
                ...
                <span>Advanced candidate search and filtering</span>
              </div>
              <div className="flex items-center gap-3 text-white/70">
                <Zap className="w-4 h-4 text-[#FF5A1F]" />
                <span>Detailed candidate profiles and portfolios</span>
              </div>
              <div className="flex items-center gap-3 text-white/70">
                <Zap className="w-4 h-4 text-[#FF5A1F]" />
                <span>Talent pool management and organization</span>
              </div>
            </div>
